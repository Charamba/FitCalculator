...
export default function FitCalculator() {
  ...
  return (
    <div className="flex flex-col items-center p-4 w-full">
      ...
      <br></br>
      <p className="text-sm"> Última atualização: 14-06-2025 [16] </p>
    </div>
  );
}
    ...
    <div className="flex flex-col items-center gap-4 p-4 border rounded-lg shadow-lg w-full">
      ...
      {/* <form onSubmit={handleSubmit} className="space-y-4 center"> */}
        ...
        <div className="flex flex-col w-full">
          ...
          🛋️ <b>Sedentário</b> (pouco ou nenhum exercício): <br></br>TMB × 1.2</li>
          <li className="text-sm">
          🚶 <b>Levemente ativo</b> (exercício leve 1-3 dias/semana): <br></br>TMB × 1.375</li>
          <li className="text-sm">
          🏃 <b>Moderadamente ativo</b> (exercício moderado 3-5 dias/semana): <br></br>TMB × 1.55</li>
          <li className="text-sm">
          🏋️ <b>Muito ativo</b> (exercício intenso 6-7 dias/semana): <br></br>TMB × 1.725</li>
          <li className="text-sm">
          🏆 <b>Extremamente ativo</b> (atletas ou trabalho físico intenso): <br></br>TMB × 1.9</li>
          </ul>
